                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('password') || session('err.meta.errors.password') ? ' has-error' : '' }}">
                                ...
                                @endif
                                    ...
                                    @if(session('err.meta.errors.password'))
                                        <span class="help-block">
                                            @foreach(session('err.meta.errors.password') as $err)
                                               <p><strong>{{ $err }}</strong></p>
                                            @endforeach
                                    </span>
                                    @endif
